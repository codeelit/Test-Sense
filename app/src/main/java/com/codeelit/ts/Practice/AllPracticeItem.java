...
public class AllPracticeItem {
    ...
    public AllPracticeItem() {
    }

    public AllPracticeItem(String courseTitle, String CDescription2, String dificulty, String pre2, String cimageUri) {
    ...
    public static final ArrayList<AllPracticeItem> getTestingList() {
        ArrayList<AllPracticeItem> Courses = new ArrayList<>();
        Courses.add(0, new AllPracticeItem(
                "Basic Aptitude",
        ...
        Courses.add(1, new AllPracticeItem(
                "Advance Aptitude",
        ...
        Courses.add(2, new AllPracticeItem(
                "Technical Aptitude",
        ...
        Courses.add(3, new AllPracticeItem(
        ...
        Courses.add(4, new AllPracticeItem(
                "Advance Programming",
